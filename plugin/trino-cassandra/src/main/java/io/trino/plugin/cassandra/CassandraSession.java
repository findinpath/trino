        ...
        implements Closeable
{
    ...
    public CassandraSession(JsonCodec<List<ExtraColumnMetadata>> extraColumnMetadataCodec, Supplier<CqlSession> sessionSupplier, Duration sessionRefreshInterval, Duration noHostAvailableRetryTimeout)
    {
        ...
        this.session = memoizeWithExpiration(sessionSupplier::get, sessionRefreshInterval.roundTo(sessionRefreshInterval.getUnit()), sessionRefreshInterval.getUnit());
    }
